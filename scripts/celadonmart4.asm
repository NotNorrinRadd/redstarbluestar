...
CeladonMart4ClerkText:
	TX_MART POKE_DOLL, FIRE_STONE, THUNDER_STONE, WATER_STONE, LEAF_STONE, HEART_STONE, METAL_COAT, KINGS_ROCK, POISON_STONE, UPGRADE, DRAGON_SCALE, SLOWPOKETAIL, LINK_CABLE

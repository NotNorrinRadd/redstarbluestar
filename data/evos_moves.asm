...
; Learnset
	...
	db 27, HAZE
	db 36, SCREECH
	db 44, SPLASH ;MOONLIGHT
	db 45, SPLASH ;STALKER
	db 54, WING_ATTACK
	db 63, CONFUSE_RAY
	db 0
...
; Learnset
	...
	db 25, WING_ATTACK
	db 31, SWORDS_DANCE
	db 37, SPLASH ;FALSE SWIPE
	db 43, AGILITY
	db 49, SLASH
	db 55, SPLASH ;FURY CUTTER
	db 0
...
; Learnset
	...
	db 16, DOUBLE_TEAM
	db 23, SLASH
	db 31, SPLASH ;FALSE SWIPE
	db 40, SPLASH ;PURSUIT
	db 50, SWORDS_DANCE
	db 61, SPLASH ;FURY CUTTER
	db 73, AGILITY
	db 0
...
; Learnset
	...
	db 30, SCREECH
	db 37, DIG
	db 45, SPLASH ;SANDSTORM
	db 53, SLAM
	db 62, SPLASH ;IRON TAIL
	db 0

FarfetchdEvosMoves:
; Evolutions
    db EV_LEVEL, 24, MADAME
	db 0
; Learnset
	db 7, LEER
	db 15, FURY_ATTACK
...
; Learnset
    db 7, LEER
	db 13, SPLASH ;RAPID SPIN
	db 20, SPLASH ;PURSUIT
	db 27, MEDITATE
	db 35, ROLLING_KICK
	db 43, SPLASH ;DETECT
	db 52, SPLASH ; MIND READER
	db 61, SPLASH ; TRIPLE KICK
	db 71, FOCUS_ENERGY
	db 0
...
; Learnset
	...
	db 32, PIN_MISSILE
	db 33, QUICK_ATTACK
	db 41, SPLASH ;DRAGONBREATH
	db 49, AGILITY
	db 57, SPLASH ;OCTAZOOKA
	db 65, HYDRO_PUMP
	db 0
...
; Evolutions
	...
	db EV_ITEM, POISON_STONE, 1, BELMITT
	db 0
; Learnset
	db 13, WRAP
	db 15, POISONPOWDER
